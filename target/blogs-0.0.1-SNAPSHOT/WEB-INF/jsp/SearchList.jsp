        ...
        <div class="navbar-search" onclick="">
            ...
            <form role="search" onsubmit="return false;">
                <span class="search-box">
                    <input type="text" id="search-inp" class="input" placeholder="搜索功能暂时未开放..." maxlength="30" autocomplete="off">
                </span>
            </form>
        </div>
...
<div class="main-content index-page clearfix">
    <div class="post-lists">
        ...
        <c:forEach items="${serchArticle}" var="article" varStatus="vs"> 
    ...
    <li class="current">&nbsp;&nbsp;共${searchPage.totalPage }页</li>
    <li class="next"><a href="/cat_article/${cateId}?page=${searchPage.currentPage-1}">${searchPage.currentPage<=1? "&nbsp;":"上一页" }</a></li>
    <li>&nbsp;&nbsp;当前第${searchPage.currentPage }页</li>

    <li class="next"><a href="/cat_article/${cateId}?page=${searchPage.currentPage+1}">${searchPage.currentPage>=searchPage.totalPage? "&nbsp;":"下一页" }</a></li>
</ol>
    </div>
</div>
