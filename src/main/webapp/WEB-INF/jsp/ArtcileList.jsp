...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <meta name="description" content="个人博客系统，SSM框架">
...
<div class="main-content index-page clearfix">
        ...
        <c:forEach items="${articles}" var="article" varStatus="vs"> 
            <div class="post-list-item">
                <div class="post-list-item-container">
                    <div class="item-thumb bg-deepgrey" style="background-image:url(${article.image});"></div>
                    ...
                    <div class="item-label">
                        <div class="item-title"><a href="/article/${article.id}">${article.title}</a>
                        </div>
                        <div class="item-meta clearfix">
                            <div class="item-meta-ico bg-ico-image" style="background: url(/image/bg-ico.png) no-repeat;background-size: 40px auto;"></div>
    ...
    <li class="current">&nbsp;&nbsp;共${frontArtPage.totalPage }页</li>
    <li class="next"><a href="/cat_article/${cateId}?page=${frontArtPage.currentPage<=1?1:frontArtPage.currentPage-1}">${frontArtPage.currentPage<=1? "&nbsp;":"上一页" }</a></li>
    <li>&nbsp;&nbsp;当前第${frontArtPage.currentPage }页</li>

    <li class="next"><a href="/cat_article/${cateId}?page=${frontArtPage.currentPage>=frontArtPage.totalPage?frontArtPage.totalPage:frontArtPage.currentPage+1}">${frontArtPage.currentPage>=frontArtPage.totalPage? "&nbsp;":"下一页" }</a></li>
</ol>
    </div>
</div>
